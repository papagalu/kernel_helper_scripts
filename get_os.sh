...
function GetOSVersion {
    ...
    export os_VENDOR os_RELEASE os_UPDATE os_PACKAGE os_PACKAGE_MANAGER os_CODENAME
}

########################################################################
#
# Echo the required packages that are needed to build the kernel
#
########################################################################
...
########################################################################
#
# We run GetOSVersion because we want it to be ran when we source the
# script
#
########################################################################
